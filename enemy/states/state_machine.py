...
from enemy.states.walk import EnemyWalkState
from enemy.states.hit import EnemyHitState
...
class StateMachine:
    def __init__(self, context) -> None:
        self._state = 'idle'
        self._states = {
            'idle': EnemyIdleState(context, {'walk', 'hit'}),
            'walk': EnemyWalkState(context, {'idle', 'hit'}),
            'hit': EnemyHitState(context, {'idle'})
        }
